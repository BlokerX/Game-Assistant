...
namespace GameAssistant
{
    ...
    public partial class FPSCounterWidget : WidgetWindow
    {
        ...
        public FPSCounterWidget()
        {
            ...
            fcwTimer.Interval = TimeSpan.FromMilliseconds(50);
        ...
        void OutputThreadProc()
        {
            ...
            string nameOfProcess = "dwm";

            foreach (var x in frames.Values)
            {
                if (x.Name == "osu!") nameOfProcess = x.Name;
            }
        ...
        public static void _RunerMain_()
        {
